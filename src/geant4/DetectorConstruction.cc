...
G4VPhysicalVolume* DetectorConstruction::Construct() {
  ...
  // *** End detector ***
  {
    ...
    fLogicEndDet = logicEndDet; // Volume used later to record/export hits 
  ...
  // *** Scintillator detector ***
  {
    ...
    fLogicScintDet = logicScintDet; // Volume used later to record/export hits 
  ...
  // *** Kill box faces *** 
  {
    ...
    fLogicKillBoxFaces.push_back(logicKillBox1);
    ...
    fLogicKillBoxFaces.push_back(logicKillBox2);
    ...
    fLogicKillBoxFaces.push_back(logicKillBox3);
    ...
    fLogicKillBoxFaces.push_back(logicKillBox4);
    ...
    fLogicKillBoxFaces.push_back(logicKillBox5);
...
void DetectorConstruction::ConstructSDandField() {
  ...
  auto endDet = new DetectorSD("EndDetector");
  sdManager->AddNewDetector(endDet);
  if (fLogicEndDet) fLogicEndDet->SetSensitiveDetector(endDet);

  
  auto scintDet = new DetectorSD("ScintDetector");
  sdManager->AddNewDetector(scintDet);
  if (fLogicScintDet) fLogicScintDet->SetSensitiveDetector(scintDet);


  auto killBox = new DetectorSD("KillBox");
  sdManager->AddNewDetector(killBox);

  for (auto logicKillFace : fLogicKillBoxFaces) {
    if (logicKillFace) {
      logicKillFace->SetSensitiveDetector(killBox);
    }
  }
